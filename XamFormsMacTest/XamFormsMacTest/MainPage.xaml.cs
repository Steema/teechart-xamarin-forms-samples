...
namespace XamFormsMacTest
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            BarChart.WidthRequest = 600;
            BarChart.HeightRequest = 400;

            BarChart.Chart.Panel.Gradient.Visible = false;
            //BarChart.Chart.Aspect.View3D = true;
            Random x= new Random();
            BarChart.Chart.Panel.Color = Color.FromRgb(x.Next(255),x.Next(255),x.Next(255));

            Bar line = new Bar();
            line.FillSampleValues();
            BarChart.Chart.Series.Add(line);
