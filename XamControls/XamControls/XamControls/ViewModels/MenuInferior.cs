...
namespace XamControls.ViewModels
{
	public class MenuInferior : StackLayout
	{
		...
		private void InicialitzarMenuInferior()
		{
            ...
            if (Device.RuntimePlatform == Device.iOS) sLMenuInferior.VerticalOptions = LayoutOptions.FillAndExpand;
            ...
            if (Device.RuntimePlatform == Device.iOS)
            {
                ...
                scrollView.BackgroundColor = frame.BackgroundColor;
            }

			// "Scroll" del menú inferior
			scrollView.Orientation = ScrollOrientation.Horizontal;
			scrollView.VerticalOptions = LayoutOptions.EndAndExpand;
            if (Device.RuntimePlatform == Device.iOS) scrollView.VerticalOptions = LayoutOptions.FillAndExpand;
