...
#endif
{
  public static class Variables
  {
...
#endif
    {
      ...
      if (tChart1.Series[0] is Styles.ColorGrid)
      {
        ColorGrid colorgrid = ((ColorGrid)(tChart1.Series[0]));
        tChart1.Aspect.View3D = false;
      }
      ...
      {
        tChart1.Header.Text = "Circular Series";
      ...
      if ((tChart1.Series[0] is Donut))
      {
        Donut donut = ((Donut)(tChart1.Series[0]));
        donut.CircleGradient.Visible = false;
        tChart1.Aspect.View3D = false;
        tChart1.Legend.Transparent = true;
      }
      ...
      if (tChart1.Series[0] is Styles.CustomError)
      {
        ...
        if (tChart1.CurrentTheme == ThemeType.BlackIsBack)
          error.ErrorPen.Color = Color.FromRgb(212,212,212);
        else
          error.ErrorPen.Color = Color.Black;
      }

      if (tChart1.Series[0] is Styles.CustomErrorPoint)
      {
        if (tChart1.CurrentTheme == ThemeType.BlackIsBack)
        {
          ((Styles.CustomErrorPoint)(tChart1.Series[0])).Errors.Format.Left.Color = Color.White;
          ((Styles.CustomErrorPoint)(tChart1.Series[0])).Errors.Format.Top.Color = Color.White;
          ((Styles.CustomErrorPoint)(tChart1.Series[0])).Errors.Format.Right.Color = Color.White;
          ((Styles.CustomErrorPoint)(tChart1.Series[0])).Errors.Format.Bottom.Color = Color.White;
        }
      }

      if (tChart1.Series[0] is Styles.CustomErrorPoint3D)
      {
        if (tChart1.CurrentTheme == ThemeType.BlackIsBack)
        {
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Left.Color = Color.White;
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Top.Color = Color.White;
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Right.Color = Color.White;
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Bottom.Color = Color.White;
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Back.Color = Color.White;
          ((Styles.CustomErrorPoint3D)(tChart1.Series[0])).Errors.Format.Front.Color = Color.White;          
        }
      }

      if (tChart1.Series[0] is Styles.Points3D)
      {
          (tChart1.Series[0] as Styles.Points3D).LinePen.Color = Color.Blue;
      }
      ...
      if (tChart1.Series[0] is Styles.Gantt)
      {
        ...
        gantt.LinePen.Color = Color.White;
        tChart1.Axes.Bottom.Labels.Angle = 90;
        tChart1.Axes.Bottom.Labels.Font.Size = 8;
        gantt.ConnectingPen.Color = Color.White;
      }
      ...
      if (tChart1.Series[0] is Styles.Gauges)   
      {
        Gauges gauge = ((Gauges)(tChart1.Series[0]));
        gauge.Pen.Color = Color.White;
      }

      if (tChart1.Series[0] is Styles.NumericGauge)   //pending
      {
        NumericGauge nGauge = ((NumericGauge)(tChart1.Series[0]));
                nGauge.FillSampleValues();
        nGauge.TextMarker.Shape.Font.Color = Color.Red;
      ...
      if (tChart1.Series[0] is Styles.Box)
      {
        ...
        box.MedianPen.Color = Color.Red;
        box.WhiskerPen.Color = Color.Green;              
      }
      ...
      if (tChart1.Series[0] is Styles.OrgSeries)
      {
        ...
        for (int i = 0; i < org.Count; i++)
        {
          ...
          if (tChart1.CurrentTheme == ThemeType.BlackIsBack)
          {
            ((OrgItem)(org.Items[i])).Format.Font.Color = Color.Gray;
            ((OrgItem)(org.Items[i])).Format.Pen.Color = Color.Gray;
//            ((OrgItem)(org.Items[i])).Format.Color = Color.Red;
          }
      ...
      if (tChart1.Series[0] is Styles.Tower)
      {
        ...
        tChart1.Header.Text = "Tower Series";
        ...
        tChart1.Tools.Add(Steema.TeeChart.Tools.Tool.NewFromType(typeof(Steema.TeeChart.Tools.Rotate)));
      }
    ...
    public static void AddDash()
    {
      ...
      //UWP development temporarily out DashTrend
      List<String> list = new List<String> { AppResources.DashGeographic, AppResources.DashExposure, AppResources.DashDigital };
