...
namespace StandardSeriesXFormsSTD
{
	public class SalesFigures : ContentPage
	{
		...
		public SalesFigures ()
		{
            ...
            this.tChart1.Chart.Header.Lines = new string[] {"Sales Figures"};
            ...
            this.tChart1.Chart.Legend.Font.Size = 9;
            ...
            */
            ...
            tChart1.Chart.Axes.Bottom.Labels.Style = Steema.TeeChart.AxisLabelStyle.Text;
            tChart1.Chart.Axes.Left.Increment = 3;

            tChart1.Chart.Axes.Left.SetMinMax(0, 15);
